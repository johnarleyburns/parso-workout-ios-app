    ...
    func testEveryPersistedModelHasTheExpectedCloudKitAttributes() {
        let expected: [String: Set<String>] = [
            ...
            "CardioWorkout": ["activeEnergy", "avgHeartRate", "customTitle", "deletedAt",
                               ...
                               "cardioAlgorithmVersionRaw", "effectiveRestingHR",
                               "effectiveMaximumHR", "heartRateMaximumSourceRaw",
                               "trainingZonePolicyRaw", "intensitySummaryData", "intensityProfileData",
                               "standardMETMinutes", "standardMETValue", "metBasisRaw", "metMethodRaw"],
