...
final class WatchStrengthSettingsTests: XCTestCase {
    ...
    func testPlateIncrementsUseCommonPoundAndKilogramPlates() {
        XCTAssertEqual(WeightIncrement(unit: .pounds).positiveChips, [45, 35, 25, 10, 5])
        XCTAssertEqual(WeightIncrement(unit: .pounds).negativeChips, [-45, -35, -25, -10, -5])
        XCTAssertEqual(WeightIncrement(unit: .kilograms).positiveChips, [25, 20, 15, 10, 5])
        XCTAssertEqual(WeightIncrement(unit: .kilograms).negativeChips, [-25, -20, -15, -10, -5])
